...
class GoCommand(Command):
    ...
    def execute(self, context, args):
        ...
        logger.debug(f"Minimizing for {n_steps} steps using {context.stepper.__class__.__name__}")
...
class LiveVisCommand(Command):
    ...
    def execute(self, context, args):
        ...
        logger.info(f"Live visualization {'enabled' if context.minimizer.live_vis else 'disabled'}")
