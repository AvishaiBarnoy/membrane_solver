...
- Refreshed `kh_strict_outerband_tight` acceptance baseline metrics after preset retuning (`rim-local step=1`, `band=5λ`) to keep strict reproducibility deterministic.
