...
BASELINES = {
    ...
    "kh_physical_section_tight_disabled": ROOT
    / "tests"
    / "fixtures"
    / "flat_disk_one_leaflet_kh_physical_section_tight_disabled_baseline.yaml",
    "kh_physical_outerband_tight_disabled": ROOT
    / "tests"
    / "fixtures"
