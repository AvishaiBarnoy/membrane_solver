...
def test_curved_bilayer_near_rim_matches_tensionless_theory(
    ...
    # The free-side inner channel is relaxed rather than Dirichlet-pinned. It
    # should remain suppressed relative to the driven outer channel, but
    # forcing it to machine zero changes the protected theta-energy ordering.
    assert abs(theta_outer_in) < 0.10 * abs(theta_outer_out)
