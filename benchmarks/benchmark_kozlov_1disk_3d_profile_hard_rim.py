#!/usr/bin/env python3
"""Benchmark: Kozlov 1-disk hard-rim profile relaxation (tensionless).

This benchmark runs a coarse-to-fine relaxation sequence on the R12 hard-rim
mesh to encourage curvature + leaflet tilt induction. It is meant to exercise
refinement + tilt coupling while staying lightweight.
"""
...
MESH = ROOT / "benchmarks" / "inputs" / "bench_kozlov_1disk_profile_hard_rim_R12.yaml"
RUNS = 2
